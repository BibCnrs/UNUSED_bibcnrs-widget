...
export const BibHeader = ({EBSCO_WIDGET_domain, EBSCO_WIDGET_username, EBSCO_WIDGET_availableDomains}) => {
    return (
        <div className="connexion">
            <a href="">
                <img src={process.env.NODE_ENV === 'test' ? `lib/images/bibcnrs-logo-${EBSCO_WIDGET_domain || 'visite'}.png` : require(`../images/bibcnrs-logo-${EBSCO_WIDGET_domain || 'visite'}.png`)} className="bibcnrslogo"/>
            </a>
